...
def load_and_cache_example(args, tokenizer, processor, data_type):
    ...
    if os.path.exists(cached_features_file):
        ...
        features = sim_convert_examples_to_features(examples=examples, tokenizer=tokenizer,
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if 0 == (step + 1) % args.gradient_accumulation_steps:
                ...
                # 100以內，每隔50步評估一次，1000以內，每隔100步評估一次，之後每200步評估一次
...
def evaluate(args, model, eval_dataset):
    ...
    total_sample_num = 0  # 樣本總數
    all_real_label = []  # 記錄所有真實標籤list
    all_pred_label = []  # 記錄所有預測標籤list
